  ...
  <div>
    ...
    <ul class="space-y-4">
      <li class="p-4 border border-gray-100 rounded-lg">
        ...
        <p class="mt-2 lg:mt-4 text-gray-900 text-justify tracking-[0.7px]">
          晚上起床上廁所看到照片裡的人一直動其實有點恐怖，希望可以有暫停或是定時的功能！
        </p>

        <div class="p-4 mt-2 lg:mt-4 bg-gray-50">
          <div class="text-xs lg:text-sm text-red tracking-[0.53px]">
            提案者回覆
          </div>
          <p class="mt-1 lg:mt-0 text-gray-900 text-justify tracking-[0.7px]">
