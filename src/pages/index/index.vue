  ...
  <article>
    <section>
      ...
      <h2 class="mt-4 lg:mt-6 text-xl lg:text-2xl tracking-[1.6px] font-bold">
        <span class="inline-block mr-3.5 w-1 h-5 lg:h-7 bg-yellow translate-y-1"></span>施了魔法的照片
      </h2>
    ...
    <section>
      ...
      <h2 class="mt-4 lg:mt-6 text-xl lg:text-2xl tracking-[1.6px] font-bold">
        <span class="inline-block mr-3.5 w-1 h-5 lg:h-7 bg-yellow translate-y-1"></span>留下當下的美好
      </h2>
